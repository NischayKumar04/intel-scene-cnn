...
from src.model import build_mobilenetv2_feature_extractor
from src.config import EPOCHS, SAVED_MODEL_DIR, FIGURES_DIR


EXPERIMENT_NAME = "mobilenetv2_feature_extractor_180"
...
def main():
    ...
    model = build_mobilenetv2_feature_extractor(num_classes=len(class_names))
    ...
    callbacks = [
        tf.keras.callbacks.ModelCheckpoint(
            filepath=str(SAVED_MODEL_DIR / f"best_{EXPERIMENT_NAME}.keras"),
    ...
    model.save(SAVED_MODEL_DIR / f"final_{EXPERIMENT_NAME}.keras")
